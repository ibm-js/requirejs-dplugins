	...
	grunt.initConfig({
		amdloader: {
			...
			paths: {
				...
				"requirejs-dplugins": "../../.."	// may not work due to grunt-amd-build problem with ..
			},

			// Unfortunately this is needed for the jquery plugin.
			// It's automatically handled by the plugin itself during development, but not for builds.
			map: {
				"*": {
